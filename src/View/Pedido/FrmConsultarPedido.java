...
public class FrmConsultarPedido extends javax.swing.JFrame {
    ...
    private void populateTable(){
        ...
        String[][] data = new PedidoDAO().GetAll();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Data", "Cliente", "Endereço", "Observação"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int pedidoId = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
        
        boolean resultado = dao.delete(pedidoId);
        
        if(resultado){
            JOptionPane.showMessageDialog(null, "Pedido excluído.", "SUCESSO", 2);
            
            this.dispose();
            
            new FrmConsultarPedido().setVisible(true);
        }else{
            JOptionPane.showMessageDialog(null, "Falha ao excluir pedido.", "ERRO", 2);
        }
